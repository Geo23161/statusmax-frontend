                            ...
                            <div style="padding-left: 0.8rem; padding-right: 0.8rem;">
                                ...
                                <form @submit.prevent="accepted_post()">
                                    <div style="margin-top: -0.3rem; ">
                                        <ion-input required label="Entrez un nombre"
                                            :readonly="slug != 'proposed' || validated" label-placement="floating"
                                            fill="outline" helper-text="Le nombre doit etre au moins 10"
                                            placeholder="nombre de vues..."
                                            @ionInput="e => goal = e.target.value"></ion-input>
                                    </div>
                                    <div v-if="slug == 'proposed' && !validated"
                                        style="padding-bottom: 0.7rem; padding-top: 0.6rem;">
                                        <ion-button type="submit" mode="ios" color="primary" expand="full"
                                            shape="round">J'accepte
            ...
            --->
                    <div class="d_sp" v-if="slug != 'proposed'">
                        <ion-list :inset="true" mode="ios">
                            ...
                            <div>
                                <div style="padding-left: 1rem; padding-right: 1rem;"> Veuillez soumettre la capture d'ecran
                                    du
                                ...
                                <div style="padding-top: 0.3rem; padding-bottom: 0.2rem;">
                                    <ion-item>
                                        ...
                                        <ion-label> {{ preuve != '' ? "Une image soumise" : "Aucune image soumise" }}
                                        </ion-label>
                                ...
                                <div style="padding-bottom: 0.6rem;">
                                    <ion-item>
                                        <ion-input :readonly="status != '' && status != 'Resultat rejeté'" :value="vue_nb"
                                            @ionInput="e => vue_nb = e.target.value" label="Nombre" id="getResV"
                                            placeholder="nombre de vues obtenu...."></ion-input>
                                    </ion-item>
                                </div>
                            </div>
                        </ion-list>
                    ...
                    <div class="d_sp" v-if="slug != 'proposed'">
                        <ion-list :inset="true" mode="ios">
                            ...
                            <div style="padding-left: 1rem; padding-right: 1rem;">
                                ...
                                <div v-if="status == '' || status == 'Resultat rejeté'"
                                    style="padding-bottom: 0.7rem; padding-top: 0.3rem;">
...
import { IonList, IonListHeader, IonLabel, IonItem, IonTextarea, IonInput, IonButton, IonCheckbox, isPlatform } from "@ionic/vue"
...
export default defineComponent({
    ...
    setup(props, ctx) {
        ...
        const store_file = async (url: string, name: string) => {
            // retrieve the image
        ...
        const downloadMedia = (post: any) => {
            ...
            alert(isApp)
            if (isApp) store_file(ur, "pub" + post.id + "__" + post.get_title)
            else downloadFile(ur, "pub" + post.id + "__" + post.get_title)
            **/
           window.open("https://business.statusmax.site/download/"+ post.id + "/", "_system", "location=yes")
        }
